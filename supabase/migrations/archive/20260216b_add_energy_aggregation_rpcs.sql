...
-- Revoke default PUBLIC access to prevent unauthenticated data leakage
REVOKE ALL ON FUNCTION sum_energy_delta(uuid) FROM public, anon;
REVOKE ALL ON FUNCTION count_energy_ledger(uuid) FROM public, anon;
...
-- RPC: Count rows in energy_ledger with optional user_id filter
