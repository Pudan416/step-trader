...
- After publishing integration changes, fast-forward the local `codex/current-integration` checkout too. Preserve any dirty work in a named backup commit first; pushing from a detached checkout does not update that local branch.
