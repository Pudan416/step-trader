...
- Build the `Nowhere` app scheme and its embedded extensions together from the same checkout, using a dedicated DerivedData directory. Installing the app replaces its embedded widget and Screen Time extensions too.
