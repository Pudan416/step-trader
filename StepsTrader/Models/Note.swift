...
enum NoteCatalog {
    static let all: [Note] = [
        ...
        Note(id: "about_colors_economy",
             topic: String(localized: "About Colors", comment: "Note topic"),
             body: String(localized: "Colors are not a currency. I mean they are, but I'm not planning to sell them in microtransactions or whatever. Colors are yours. You deserve them, you earn them, you can always add more. Within limits, of course.", comment: "Note body: about_colors_economy")),
        Note(id: "about_kosta",
