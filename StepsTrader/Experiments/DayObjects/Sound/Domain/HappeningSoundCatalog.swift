...
enum HappeningSoundCatalog {
    ...
    static let recipes: [HappeningSoundRecipe] = [
        tonal(1, identity: .init(workingName: "Warm analog ping", paletteKind: .synth, topology: "analog-ping", attackTopology: "triangle-sine-closing-filter", tailTopology: "tape-echo"), family: .synthPluck, range: 72...83, gainDB: -12.0, attack: 0.010, release: 1.20, delayMix: 0.18, feedback: 0.22, reverbMix: 0.30, filterStart: 2_400, filterEnd: 9_400),
        tonal(2, identity: .init(workingName: "Glass FM droplet", paletteKind: .synth, topology: "fm-droplet", attackTopology: "fm-falling-index", tailTopology: "dark-diffusion"), family: .synthPluck, range: 72...83, gainDB: -11.5, attack: 0.012, release: 1.35, delayMix: 0.20, feedback: 0.25, reverbMix: 0.34, filterStart: 2_100, filterEnd: 8_800),
        tonal(3, identity: .init(workingName: "Muted pulse pluck", paletteKind: .synth, topology: "pulse-pluck", attackTopology: "lowpass-impulse", tailTopology: "short-room"), family: .synthPluck, range: 72...83, gainDB: -12.5, attack: 0.008, release: 1.05, delayMix: 0.16, feedback: 0.20, reverbMix: 0.28, filterStart: 2_800, filterEnd: 10_200),
        tonal(4, identity: .init(workingName: "Hollow string", paletteKind: .synth, topology: "waveguide-string", attackTopology: "waveguide-noise-excitation", tailTopology: "dry-damping"), family: .synthPluck, range: 72...83, gainDB: -11.8, attack: 0.015, release: 1.50, delayMix: 0.24, feedback: 0.28, reverbMix: 0.36, filterStart: 1_900, filterEnd: 7_600),
        tonal(5, identity: .init(workingName: "Air reed blip", paletteKind: .synth, topology: "reed-blip", attackTopology: "bandpassed-breath-settle", tailTopology: "filtered-breath"), family: .synthPluck, range: 72...83, gainDB: -12.2, attack: 0.010, release: 1.25, delayMix: 0.19, feedback: 0.24, reverbMix: 0.32, filterStart: 2_300, filterEnd: 9_000),
        tonal(6, identity: .init(workingName: "Reverse pluck bloom", paletteKind: .hybrid, topology: "reverse-pluck", attackTopology: "reverse-triangle-swell", tailTopology: "reverse-bloom"), family: .synthPluck, range: 72...83, gainDB: -11.9, attack: 0.014, release: 1.45, delayMix: 0.22, feedback: 0.26, reverbMix: 0.35, filterStart: 2_000, filterEnd: 8_300),

        tonal(7, identity: .init(workingName: "Wooden kalimba", paletteKind: .organic, topology: "kalimba-modal", attackTopology: "damped-thumb-wood", tailTopology: "dry-damping"), family: .acousticMallet, range: 60...71, gainDB: -10.8, attack: 0.004, release: 1.65, delayMix: 0.14, feedback: 0.18, reverbMix: 0.42, filterStart: 1_600, filterEnd: 11_000),
        tonal(8, identity: .init(workingName: "Ceramic knock", paletteKind: .synth, topology: "ceramic-modal", attackTopology: "ceramic-damped-impulse", tailTopology: "modal-decay"), family: .acousticMallet, range: 60...71, gainDB: -11.1, attack: 0.006, release: 1.80, delayMix: 0.16, feedback: 0.20, reverbMix: 0.45, filterStart: 1_400, filterEnd: 10_400),
        tonal(9, identity: .init(workingName: "Soft marimba", paletteKind: .organic, topology: "vcsl-marimba-dark", attackTopology: "soft-marimba-mallet", tailTopology: "dark-diffusion"), family: .acousticMallet, range: 60...71, gainDB: -10.6, attack: 0.005, release: 1.55, delayMix: 0.12, feedback: 0.16, reverbMix: 0.38, filterStart: 1_800, filterEnd: 11_800),
        tonal(10, identity: .init(workingName: "Balafon brush", paletteKind: .organic, topology: "vcsl-balafon-dry", attackTopology: "balafon-brush", tailTopology: "dry-damping"), family: .acousticMallet, range: 60...71, gainDB: -11.4, attack: 0.008, release: 2.05, delayMix: 0.18, feedback: 0.22, reverbMix: 0.48, filterStart: 1_300, filterEnd: 9_600),
        tonal(11, identity: .init(workingName: "Muted vibraphone", paletteKind: .hybrid, topology: "vcsl-vibe-chorus", attackTopology: "muted-vibe-strike", tailTopology: "chorus-decay"), family: .acousticMallet, range: 60...71, gainDB: -10.9, attack: 0.005, release: 1.75, delayMix: 0.15, feedback: 0.19, reverbMix: 0.43, filterStart: 1_500, filterEnd: 10_800),
        tonal(12, identity: .init(workingName: "Felt key", paletteKind: .organic, topology: "felt-key", attackTopology: "felt-hammer", tailTopology: "short-room"), family: .acousticMallet, range: 60...71, gainDB: -11.2, attack: 0.007, release: 1.95, delayMix: 0.17, feedback: 0.21, reverbMix: 0.46, filterStart: 1_350, filterEnd: 10_000),

        tonal(13, identity: .init(workingName: "Soft metal bowl", paletteKind: .hybrid, topology: "metal-bowl-modal", attackTopology: "damped-metal-impulse", tailTopology: "modal-decay"), family: .acousticBell, range: 72...83, gainDB: -13.5, attack: 0.003, release: 3.20, delayMix: 0.26, feedback: 0.30, reverbMix: 0.58, filterStart: 1_100, filterEnd: 12_800),
        tonal(14, identity: .init(workingName: "Glass tap bloom", paletteKind: .hybrid, topology: "glass-reverse", attackTopology: "tiny-glass-tap", tailTopology: "reverse-bloom"), family: .acousticBell, range: 72...83, gainDB: -13.2, attack: 0.004, release: 3.45, delayMix: 0.28, feedback: 0.32, reverbMix: 0.62, filterStart: 1_000, filterEnd: 12_200),
        tonal(15, identity: .init(workingName: "Chorus kalimba", paletteKind: .hybrid, topology: "chorus-kalimba", attackTopology: "plucked-tine", tailTopology: "chorus-decay"), family: .acousticBell, range: 72...83, gainDB: -12.9, attack: 0.003, release: 2.85, delayMix: 0.24, feedback: 0.28, reverbMix: 0.54, filterStart: 1_250, filterEnd: 13_400),
        tonal(16, identity: .init(workingName: "Nylon pizzicato", paletteKind: .organic, topology: "nylon-waveguide", attackTopology: "nylon-string-excitation", tailTopology: "dark-diffusion"), family: .acousticBell, range: 72...83, gainDB: -13.8, attack: 0.006, release: 3.70, delayMix: 0.30, feedback: 0.34, reverbMix: 0.66, filterStart: 900, filterEnd: 11_600),
        tonal(17, identity: .init(workingName: "Dark tubular bell", paletteKind: .organic, topology: "vcsl-tubular-dark", attackTopology: "softened-tubular-strike", tailTopology: "modal-decay"), family: .acousticBell, range: 72...83, gainDB: -13.1, attack: 0.004, release: 3.05, delayMix: 0.25, feedback: 0.29, reverbMix: 0.56, filterStart: 1_150, filterEnd: 12_600),
        tonal(18, identity: .init(workingName: "Distant chime", paletteKind: .organic, topology: "vcsl-chime-dark", attackTopology: "slow-chime-strike", tailTopology: "dark-diffusion"), family: .acousticBell, range: 72...83, gainDB: -13.6, attack: 0.005, release: 3.55, delayMix: 0.29, feedback: 0.33, reverbMix: 0.64, filterStart: 950, filterEnd: 11_900),

        tonal(19, identity: .init(workingName: "Sub bloom", paletteKind: .synth, topology: "sub-bloom", attackTopology: "sub-sine-slow-open", tailTopology: "dark-diffusion"), family: .softOneShot, range: 48...59, gainDB: -11.5, attack: 0.006, release: 1.10, delayMix: 0.11, feedback: 0.16, reverbMix: 0.36, filterStart: 700, filterEnd: 6_200),
        tonal(20, identity: .init(workingName: "Analog filter ping", paletteKind: .synth, topology: "filter-ping", attackTopology: "resonant-filter-impulse", tailTopology: "tape-echo"), family: .softOneShot, range: 48...59, gainDB: -11.8, attack: 0.008, release: 1.35, delayMix: 0.13, feedback: 0.18, reverbMix: 0.40, filterStart: 600, filterEnd: 5_600),
        tonal(21, identity: .init(workingName: "Vocal droplet", paletteKind: .synth, topology: "formant-droplet", attackTopology: "two-formant-sine-excitation", tailTopology: "short-room"), family: .softOneShot, range: 48...59, gainDB: -12.1, attack: 0.010, release: 1.55, delayMix: 0.16, feedback: 0.20, reverbMix: 0.44, filterStart: 520, filterEnd: 5_000),
        tonal(22, identity: .init(workingName: "Phase-distortion bead", paletteKind: .synth, topology: "phase-distortion", attackTopology: "phase-index-decay", tailTopology: "dry-damping"), family: .softOneShot, range: 48...59, gainDB: -11.3, attack: 0.005, release: 0.95, delayMix: 0.10, feedback: 0.14, reverbMix: 0.32, filterStart: 760, filterEnd: 6_800),
        tonal(23, identity: .init(workingName: "Rubber FM bubble", paletteKind: .hybrid, topology: "rubber-fm", attackTopology: "downward-fm-pitch-settle", tailTopology: "chorus-decay"), family: .softOneShot, range: 48...59, gainDB: -11.9, attack: 0.009, release: 1.40, delayMix: 0.14, feedback: 0.19, reverbMix: 0.42, filterStart: 560, filterEnd: 5_300),
        tonal(24, identity: .init(workingName: "Bowed harmonic stab", paletteKind: .hybrid, topology: "harmonic-stab", attackTopology: "slow-bowed-harmonic-onset", tailTopology: "dry-damping"), family: .softOneShot, range: 48...59, gainDB: -12.3, attack: 0.012, release: 1.70, delayMix: 0.17, feedback: 0.22, reverbMix: 0.46, filterStart: 480, filterEnd: 4_800),

        resonant(25, identity: .init(workingName: "Breath resonator", paletteKind: .hybrid, topology: "breath-resonator", attackTopology: "filtered-breath-resonator", tailTopology: "filtered-breath"), referenceMIDI: 60, range: 60...71, resonatorTargetPitchClasses: [0, 3, 6, 9], gainDB: -15.0, attack: 0.080, release: 4.20, delayMix: 0.30, feedback: 0.36, reverbMix: 0.68, filterStart: 260, filterEnd: 6_800),
        resonant(26, identity: .init(workingName: "Bowed glass cloud", paletteKind: .hybrid, topology: "modal-glass-cloud", attackTopology: "bowed-modal-partials", tailTopology: "modal-decay"), referenceMIDI: 60, range: 60...71, resonatorTargetPitchClasses: [0, 3, 6, 9], gainDB: -14.5, attack: 0.120, release: 4.80, delayMix: 0.34, feedback: 0.40, reverbMix: 0.72, filterStart: 220, filterEnd: 5_900),
        resonant(27, identity: .init(workingName: "Granular shimmer", paletteKind: .hybrid, topology: "granular-shimmer", attackTopology: "windowed-pitched-micrograins", tailTopology: "dark-diffusion"), referenceMIDI: 60, range: 60...71, resonatorTargetPitchClasses: [0, 3, 6, 9], gainDB: -15.5, attack: 0.150, release: 5.20, delayMix: 0.38, feedback: 0.44, reverbMix: 0.76, filterStart: 180, filterEnd: 5_200),
        unpitched(28, identity: .init(workingName: "Reverse glass gesture", paletteKind: .organic, topology: "reverse-glass-unpitched", attackTopology: "reversed-filtered-glass-partials", tailTopology: "reverse-bloom"), gainDB: -14.0, attack: 0.050, release: 2.40, delayMix: 0.22, feedback: 0.28, reverbMix: 0.60, filterStart: 400, filterEnd: 7_200),
        unpitched(29, identity: .init(workingName: "Soft dust impact", paletteKind: .organic, topology: "dust-impact", attackTopology: "particulate-under-120ms", tailTopology: "filtered-breath"), gainDB: -14.8, attack: 0.090, release: 3.10, delayMix: 0.28, feedback: 0.34, reverbMix: 0.68, filterStart: 300, filterEnd: 6_000),
        unpitched(30, identity: .init(workingName: "Airy exhale", paletteKind: .organic, topology: "breath-exhale", attackTopology: "breath-formant-crossfade", tailTopology: "filtered-breath"), gainDB: -15.2, attack: 0.110, release: 3.60, delayMix: 0.32, feedback: 0.38, reverbMix: 0.72, filterStart: 240, filterEnd: 5_400),
    ]
