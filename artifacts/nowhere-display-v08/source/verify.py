...
for style in ['Regular','Bold']:
 p=R/f'fonts/NowhereDisplay08-{style}.ttf';f=TTFont(p);base=TTFont(R/f'source/base-{style}.ttf');wf=TTFont(p.with_suffix('.woff2'));cm=f.getBestCmap();order=f.getGlyphOrder()
