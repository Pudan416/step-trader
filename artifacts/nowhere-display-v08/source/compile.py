def build(style):
 ...
 for rec in f['name'].names:
  names={1:'Nowhere Display 08',2:style,3:f'NowhereDisplay08-{style}-0.800',4:f'Nowhere Display 08 {style}',5:'Version 0.800',6:f'NowhereDisplay08-{style}',16:'Nowhere Display 08',17:style}
  if rec.nameID in names:rec.string=names[rec.nameID].encode(rec.getEncoding())
 f['head'].fontRevision=.8
 ...
 p=OUT/f'fonts/NowhereDisplay08-{style}.ttf';f.save(p);f.flavor='woff2';f.save(p.with_suffix('.woff2'))
