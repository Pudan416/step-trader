"""Nowhere Display 0.8: purpose-drawn continuous cubic outlines compiled to TrueType curves.
...
def redraw(style,f):
 ...
 outer=contour((w*.90,720),(w*.90,720-hair),(w*.48,720-hair),((w*.26,720-hair),(t,534),(t,399)),((w*.29,476),(w*.42,518),(w*.55,518)),((w*.84,518),(w,421),(w,258)),((w,91),(w*.80,-8),(w*.50,-8)),((w*.18,-8),(0,101),(0,296)),((0,559),(w*.15,720),(w*.48,720)),(w*.90,720))
